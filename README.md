...
Access the Chatbot: Once you see INFO: Uvicorn running on http://127.0.0.1:3000 (or similar), open your web browser and go to:
...
The chat interface will load in your browser.

Type your diabetes-related question into the input box at the bottom.

Press Enter or click the send button (✈️).

Watch DiaBot think (you'll see a typing indicator) and then deliver its RAG-powered answer!
